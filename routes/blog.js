...
let setRouter = (app) => {
  ...
  app.post(baseUrl+'/deleteAll',auth.isAuthenticated, blogController.deleteAllBlog);
...
app.get(baseUrl+'/all/comments',auth.isAuthenticated, blogController.getAllComments);
app.post(baseUrl+'/create/comments',auth.isAuthenticated, blogController.createComment);
